...
const PRESET_ADDRESSES = [
  { label: 'Active Whale / Exchange', address: 'kaspa:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73' },
  { label: 'Mining Pool Distribution', address: 'kaspa:qqje6ps46n6pvjstupfxgrg6v3pegd22q84jachnfrnz2vh5vznqw8redgln6' },
  { label: 'High Activity Wallet', address: 'kaspa:qp9rv9jvx2kyf6wu4lupuruunq5zsuszyxs0dr3l89ej7wsgs48jqkewy6xtl' },
];
